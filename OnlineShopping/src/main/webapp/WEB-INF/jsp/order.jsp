			...
			<table align="center" border="3" cellspacing="2" cellpadding="10">
				...
				<tr>
					<td align="right" colspan="5" rowspan="3"><h4>TotalAmount
							: ${totalAmount }</h4></td> 
				<input type="hidden" value="${totalAmount }" name="totalBill">
				</tr>
			</table>
			<%-- <center>
		...
		<form action="addAddress" method="post">
			<table align="center" border="3" cellspacing="2" cellpadding="10" width="500">
				...
				<tr>
					...
					<td><textarea name="address" style="width:300px; height:100px" placeholder="Correspondence address"></textarea></td>
				</tr>
				<tr>
					<td align="center" style="width:200px;">City</td>
					<td><input type="text" name="city" style="width:300px;" placeholder="City"></td>
				</tr>
				<tr>
					<td align="center" style="width:200px;">Zipcode</td>
					<td><input type="text" name="zipcode" style="width:300px;" placeholder="Zipcode"></td>
				</tr>
				<tr>

					<td align="center" style="width:200px;">State</td>
					<td><input type="text" name="state" style="width:300px;" placeholder="State"></td>
				</tr>
				<tr>
					<td align="center" style="width:200px;">District</td>
					<td><input type="text" name="dist" style="width:300px;" placeholder="District"></td>
				</tr>
				<tr>
					<td align="center" style="width:200px;">Landmark</td>
					<td><input type="text" name="landmark" style="width:300px;" placeholder="Landmark"></td>
				</tr>
			</table>
